...
If (($SingleNic -and $ConnectionServer) -or ($SingleNic -and $SmallDeploymentServer)) {
    ...
    New-NetFirewallRule -Name 'NmConn-UDP-5008-In' -DisplayName 'NetMotion Connections' -Description 'Allow inbound NetMotion Mobility connections.' -Group 'NetMotion Mobility' -Protocol UDP -LocalPort 5008 -Direction Inbound -Profile Any -Action Allow -Enabled True -ErrorAction SilentlyContinue
    New-NetFirewallRule -Name 'NmSvc-UDP-5009-In' -DisplayName 'NetMotion Service (UDP-In)' -Description 'Allow inbound NetMotion service connections.' -Group 'NetMotion Mobility' -Protocol UDP -LocalPort 5009 -Direction Inbound -Profile Any -Action Allow -Enabled True -ErrorAction SilentlyContinue
    New-NetFirewallRule -Name 'NmSvc-TCP-5009-In' -DisplayName 'NetMotion Service (TCP-In)' -Description 'Allow inbound NetMotion service connections.' -Group 'NetMotion Mobility' -Protocol TCP -LocalPort 5009 -Direction Inbound -Profile Any -Action Allow -Enabled True -ErrorAction SilentlyContinue
    New-NetFirewallRule -Name 'NmWebUI-TCP-80-In' -DisplayName 'NetMotion Web Management' -Description 'Allow inbound NetMotion web management connections.' -Group 'NetMotion Mobility' -Protocol TCP -LocalPort 80 -Direction Inbound -Profile Any -Action Allow -Enabled True -ErrorAction SilentlyContinue
    New-NetFirewallRule -Name "NmWebUI-TCP-$WebUiPort-In" -DisplayName 'NetMotion Web Management Secure' -Description 'Allow secure inbound NetMotion web management connections.' -Group 'NetMotion Mobility' -Protocol TCP -LocalPort $WebUiPort -Direction Inbound -Profile Any -Action Allow -Enabled True -ErrorAction SilentlyContinue
...
If (($DualNic -and $ConnectionServer) -or ($DualNic -and $SmallDeploymentServer)) {
    ...
    New-NetFirewallRule -Name 'NmConn-UDP-5008-In' -DisplayName 'NetMotion Connections' -Description 'Allow inbound NetMotion Mobility connections.' -Group 'NetMotion Mobility' -Protocol UDP -LocalPort 5008 -Direction Inbound -Profile Any -Action Allow -Enabled True -ErrorAction SilentlyContinue
    New-NetFirewallRule -Name 'NmSvc-UDP-5009-In' -DisplayName 'NetMotion Service (UDP-In)' -Description 'Allow inbound NetMotion service connections.' -Group 'NetMotion Mobility' -Protocol UDP -LocalPort 5009 -Direction Inbound -Profile Domain -Action Allow -Enabled True -ErrorAction SilentlyContinue
    New-NetFirewallRule -Name 'NmSvc-TCP-5009-In' -DisplayName 'NetMotion Service (TCP-In)' -Description 'Allow inbound NetMotion service connections.' -Group 'NetMotion Mobility' -Protocol TCP -LocalPort 5009 -Direction Inbound -Profile Domain -Action Allow -Enabled True -ErrorAction SilentlyContinue
    New-NetFirewallRule -Name 'NmWebUI-TCP-80-In' -DisplayName 'NetMotion Web Management' -Description 'Allow inbound NetMotion web management connections.' -Group 'NetMotion Mobility' -Protocol TCP -LocalPort 80 -Direction Inbound -Profile Domain -Action Allow -Enabled True -ErrorAction SilentlyContinue
    New-NetFirewallRule -Name "NmWebUI-TCP-$WebUiPort-In" -DisplayName 'NetMotion Web Management Secure' -Description 'Allow secure inbound NetMotion web management connections.' -Group 'NetMotion Mobility' -Protocol TCP -LocalPort $WebUiPort -Direction Inbound -Profile Domain -Action Allow -Enabled True -ErrorAction SilentlyContinue
...
If ($AnalyticsServer -or $PublisherServer) {
    ...
    New-NetFirewallRule -Name 'NmWebUI-TCP-80-In' -DisplayName 'NetMotion Web Management' -Description 'Allow inbound NetMotion web management connections.' -Group 'NetMotion Mobility' -Protocol TCP -LocalPort 80 -Direction Inbound -Profile Any -Action Allow -Enabled True -ErrorAction SilentlyContinue
    New-NetFirewallRule -Name "NmWebUI-TCP-$WebUiPort-In" -DisplayName 'NetMotion Web Management Secure' -Description 'Allow secure inbound NetMotion web management connections.' -Group 'NetMotion Mobility' -Protocol TCP -LocalPort $WebUiPort -Direction Inbound -Profile Any -Action Allow -Enabled True -ErrorAction SilentlyContinue
    New-NetFirewallRule -Name 'NmService-TCP-5009-In' -DisplayName 'NetMotion Service' -Description 'Allow inbound NetMotion service connections.' -Group 'NetMotion Mobility' -Protocol TCP -LocalPort 5009 -Direction Inbound -Profile Any -Action Allow -Enabled True -ErrorAction SilentlyContinue

    If ($AnalyticsServer) {

        New-NetFirewallRule -Name 'NmDatabase-TCP-3306-In' -DisplayName 'NetMotion Analytics Database' -Description 'Allow inbound NetMotion Analytics database connections.' -Group 'NetMotion Mobility' -Protocol TCP -LocalPort 3306 -Direction Inbound -Profile Any -Action Allow -Enabled True -ErrorAction SilentlyContinue
        New-NetFirewallRule -Name 'NmService-TCP-5673-In' -DisplayName 'NetMotion Analytics Service' -Description 'Allow inbound NetMotion Analytics service connections.' -Group 'NetMotion Mobility' -Protocol TCP -LocalPort 5673 -Direction Inbound -Profile Any -Action Allow -Enabled True -ErrorAction SilentlyContinue

    }

    Else {

        New-NetFirewallRule -Name 'NmPublisherAlert-TCP-5671-In' -DisplayName 'NetMotion Publisher Alert' -Description 'Allow inbound NetMotion publisher alert connections.' -Group 'NetMotion Mobility' -Protocol TCP -LocalPort 5671 -Direction Inbound -Profile Any -Action Allow -Enabled True -ErrorAction SilentlyContinue
        New-NetFirewallRule -Name 'NmPublisherData-TCP-5672-In' -DisplayName 'NetMotion Publisher Data' -Description 'Allow inbound NetMotion publisher data connections.' -Group 'NetMotion Mobility' -Protocol TCP -LocalPort 5672 -Direction Inbound -Profile Any -Action Allow -Enabled True -ErrorAction SilentlyContinue
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU4bnx42lXdor9QCIlFjrCELKN
# XM+gggquMIIFMDCCBBigAwIBAgIQBAkYG1/Vu2Z1U0O1b5VQCDANBgkqhkiG9w0B
...
# AQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFP0X6FcQWB+DCIWkX+WtcgmAJLaGMA0G
# CSqGSIb3DQEBAQUABIIBAJnRnAzGGfm3cVRkBk50Y/w/Ty0NtYgNXCxC64yOHHaP
# x5iQK5oWmZWMF7gaQW2RIKR6s/BVhDNQmJ/MNsMBhu0n2LeicviWJmrA3Q1nwf5M
# YwnF67+GiP2YGvvvMuZSvvB6oSOXjRabnkVz1bGq3XBxC+ony/HrLUYqXe/SPKl3
# gxlSijkOj0ni3zh69wVgQFUbQalMQXS8Ec13Lt5JBomBKThNGcu0FJwIKGPMv4pe
# UkcBnQVhQKwJff/5ud5OWK9zFng3Lrco6NKtJfx+4GMw4otxUGQr55iEJLrEzVfT
# QtGAVB3QrSe8ASlP7NawPj+oDK5UzRqK9hwRw8iTJTI=
